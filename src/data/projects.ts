...
export const PROJECTS: Project[] = [
  ...
  {
    id: 'dentis',
    title: 'DENTIS — клиника имплантации',
    niche: 'Стоматологии',
    nicheSlug: 'sayt-dlya-stomatologii',
    city: 'Казань',
    desc: 'Клиника с восемью врачами и полным прайсом: вход собран не по услугам, а по проблеме — «нет одного зуба», «съёмный протез мешает», «стесняюсь улыбки». Дальше цена с тем, что в неё входит, четыре протокола имплантации, врачи с фамилиями и работы шторкой «до и после».',
    metric: null,
    tgPost: null,
    liveUrl: 'https://manath-iq.github.io/stomatologiya/',
    poster: '/works/dentis.webp',
    video: '/works/dentis.webm',
    inHero: true,
    isDemo: true,
