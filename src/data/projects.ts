...
export const PROJECTS: Project[] = [
  ...
  {
    id: 'grand-house',
    title: 'Grand House — каменные дома под ключ',
    niche: 'Строительство домов',
    nicheSlug: 'sayt-dlya-stroitelstva-domov',
    city: 'Набережные Челны',
    desc: 'Каменные дома в Челнах и Тукаевском районе, чек от пяти миллионов. Цена и срок на первом экране, каталог проектов с планировками, пять этапов с долями оплаты, расчёт семейной и сельской ипотеки — и заявка, которая уходит компании прямо в WhatsApp.',
    metric: null,
    tgPost: null,
    liveUrl: 'https://grandhouse.manath.site/',
    poster: '/works/grand-house.webp',
    video: '/works/grand-house.webm',
    inHero: false,
    isDemo: true,
    statusLabel: 'собран под компанию · ещё не запущен',
    domain: 'grandhouse.manath.site',
    alt: 'Сайт строительной компании Grand House в Набережных Челнах — каменные дома под ключ, главная страница',
  },
  {
    id: 'dobrovet',
    ...
    metric: null,
    tgPost: null,
    liveUrl: 'https://dobrovet.manath.site/',
  ...
  },
  {
    ...
    metric: null,
    tgPost: null,
    liveUrl: 'https://clinic-template.manath.site/',
  ...
  },
  {
    ...
    metric: null,
    tgPost: null,
    liveUrl: 'https://stomatologya-template.manath.site/',
  ...
  },
  {
    ...
    metric: null,
    tgPost: null,
    liveUrl: 'https://sports-nutrition.manath.site/',
  ...
  },
  {
    ...
    metric: null,
    tgPost: null,
    liveUrl: 'https://stroika-template.manath.site/',
  ...
  },
  {
    ...
    metric: null,
    tgPost: null,
    liveUrl: 'https://kitchen-template.manath.site/',
  ...
  },
  {
    ...
    metric: null,
    tgPost: null,
    liveUrl: 'https://braces-stomat.manath.site/',
  ...
  },
  {
    ...
    metric: null,
    tgPost: null,
    liveUrl: 'https://baobab-template.manath.site/',
  ...
  },
  {
    ...
    metric: null,
    tgPost: null,
    liveUrl: 'https://old-ambar-site.manath.site/',
  ...
  },
  {
    ...
    metric: null,
    tgPost: null,
    liveUrl: 'https://alice-tour-template.manath.site/',
