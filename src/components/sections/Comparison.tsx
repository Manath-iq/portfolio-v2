...
const ROWS: Row[] = [
  ...
  },
  {
    ...
    good: 'Домен, хостинг и исходники оформляются на тебя. Уйти к другому разработчику можно в любой день.',
  },
  {
    id: 'text',
    label: 'Тексты',
  ...
  },
  {
    ...
    good: 'Я, один, с тобой напрямую. Правки 30 дней после запуска — сообщением, а не заявкой в поддержку.',
  },
]
          ...
          <div className="mt-8 grid items-start gap-8 lg:grid-cols-12 lg:gap-10">
            ...
            <Reveal delay={140} className="lg:col-span-7">
              ...
              <p className="cmp-hint t-micro mt-3 text-center lg:text-left">
                нажми на любую метку — или выбери строку в списке
              </p>
            </Reveal>
