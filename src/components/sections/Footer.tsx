    ...
    <footer className="hairline-top bg-bg-2">
      <div className="container-wide py-16">
        <div className="grid gap-10 md:grid-cols-3">
          <div>
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-[1.0625rem] font-medium">{SITE.name}</span>
            </div>
          ...
          <div>
            ...
            <ul className="mt-4 flex flex-col gap-2 text-[0.9375rem]">
              <li>
                <a href="/policy/" className="text-text-2 transition-colors hover:text-text">
                  Политика конфиденциальности
                </a>
              </li>
              <li>
                <a href="/oferta/" className="text-text-2 transition-colors hover:text-text">
                  Договор-оферта
                </a>
              </li>
              <li>
        ...
        <div className="hairline-top mt-14 flex flex-col gap-4 pt-6 sm:flex-row sm:items-center sm:justify-between">
          <p className="t-micro">
            {SITE.name}, ИП · ИНН {SITE.inn} · {SITE.city}, {SITE.region}
          </p>
